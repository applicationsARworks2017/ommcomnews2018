...
import com.lipl.ommcom.adapter.SlidingImage_Adapter;
...
public class NewsDetailsActivity extends AppCompatActivity implements FlipAdapter.OnShareClick,
        FlipAdapter.OnCommentClick,BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
                    ...
                    * */
                    ...
                    if(res.isNull("News") == false){
                        ...
                        if(jsonObj.isNull("news_image") == false) {
                            ...
                            NUM_PAGES = NUM_PAGES+array.length();
...
//Set circle indicator radius
        ...
        /**
         * Top Sliding Pagination
         * */

        List<FImageListItem> imageListItems = fImageListItems;
        ...
        for(String name : file_maps.keySet()){
            ...
            SliderViewCustom textSliderView = new SliderViewCustom(NewsDetailsActivity.this, show_play);
            textSliderView
                    .description(name)
                    .image(img_file)
                    .setScaleType(BaseSliderView.ScaleType.Fit)
                    .setOnSliderClickListener(NewsDetailsActivity.this);
        ...
        mDemoSlider.addOnPageChangeListener(NewsDetailsActivity.this);
        if(file_maps.size() > 1){
