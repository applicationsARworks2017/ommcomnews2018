...
public class NewsDetailsActivity_old extends AppCompatActivity implements FlipAdapter.OnShareClick,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(news != null
            ...
            new android.support.v7.app.AlertDialog.Builder(NewsDetailsActivity_old.this,
        ...
        tvDemo.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                for(int i = 0; i < pagination.size(); i++){
                    ...
                    flipView = new FlipViewController(NewsDetailsActivity_old.this);
                    ...
                    flipView.setAdapter(new FlipAdapter(NewsDetailsActivity_old.this, newsDetailsForFlipModels,
                            title, postedAt, postedBy, fImageListItems,
                            NewsDetailsActivity_old.this, NewsDetailsActivity_old.this, news, mFBCount, mTwitterCount, mGPlusCount));
    ...
    private void getNewsDetails(final String slug){
        if(Util.getNetworkConnectivityStatus(NewsDetailsActivity_old.this) == false){
            Util.showDialogToShutdownApp(NewsDetailsActivity_old.this);
            return;
        }
    ...
    private void setToolBar(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NewsDetailsActivity_old.this,HomeActivity.class);
...
FLAG_ACTIVITY_NEW_TASK
    ...
    private void shareInTwitter(String link){
       ...
       // Config.getTwitterIntent(NewsDetailsActivity.this,link);
        ...
        shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Ommcom News");
        shareIntent.putExtra(Intent.EXTRA_TEXT, link);

        final PackageManager pm = NewsDetailsActivity_old.this.getPackageManager();
        ...
        for (final ResolveInfo app : activityList) {
            if ("com.twitter.composer.ComposerActivity".equals(app.activityInfo.name)) {
                ...
                NewsDetailsActivity_old.this.startActivity(shareIntent);
                break;
            }
        }
    }
    ...
    private void initSocialAdapter(String link) {
        ...
        if (Utils.isOnline(getApplicationContext())) {
            ...
            pd = ProgressDialog.show(NewsDetailsActivity_old.this, null, null);
            ...
            socialAuthAdapter.authorize(NewsDetailsActivity_old.this, SocialAuthAdapter.Provider.TWITTER);
        } else {
    ...
    private void initSocialAdapterForGooglePlus(String title, String link) {
        ...
        Intent shareIntent = new PlusShare.Builder(NewsDetailsActivity_old.this)
                .setType("text/plain")
                .setText(title)
...
//        }
        ...
        public void onExecute(String arg0, Integer arg1) {
            ...
            try {
                if (status.intValue() == 200 || status.intValue() == 201
                    ...
                    if (pd != null && pd.isShowing())
                        pd.dismiss();
                    Toast.makeText(NewsDetailsActivity_old.this, "Image Uploaded",
                            Toast.LENGTH_SHORT).show();
                } else {
                    if (pd != null && pd.isShowing())
                        pd.dismiss();
                    Toast.makeText(NewsDetailsActivity_old.this, "Image not Uploaded",
                            Toast.LENGTH_SHORT).show();
                }
    ...
    public void onCommentClick() {
            Intent intent = new Intent(NewsDetailsActivity_old.this, CommentListActivity.class);
